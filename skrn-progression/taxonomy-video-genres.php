	...
	<div id="page-title-pro">
		<div id="progression-studios-page-title-container">
			<div class="width-container-pro">
				...
				?>
				<h1 class="page-title"><?php if ( !empty( $term_photo ) ) : echo '<div id="skrn-video-cast-photo-taxonomy" class="genre-icon-page-title-pro" style="background-image:url(' . $term_photo . ')"></div>'; endif; ?><?php echo esc_attr('' . $term->name . '');?></h1>
