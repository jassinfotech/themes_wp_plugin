<div id="video-search-header">
	...
	<form method="get" class="advanced-searchform-video-header" action="<?php echo esc_url($videourl); ?>">
		...
		<input type="text" class="search-field-progression" name="search_keyword" placeholder="<?php esc_html_e( 'Search for Movies or TV Series', 'skrn-progression' ); ?>" value="<?php echo esc_attr($_GET['search_keyword']); ?>" />
		
		<div id="video-search-header-filtering">
			<div id="video-search-header-filtering-padding">
				
				<ul class="skrn-video-search-columns skrn-video-search-count-<?php echo esc_attr( get_theme_mod( 'progression_studios_header_search_columns', '4') ); ?>">
				...
				<div class="video-search-header-buttons">
					<input type="submit" class="submit-search-pro" name="submit" value="<?php echo esc_html__( 'Filter Search', 'skrn-progression' ); ?>" />
					<input type="button" id="configreset" value="<?php echo esc_html__( 'Reset', 'skrn-progression' ); ?>" />
				</div>
