...
function wpvs_admin_js_activate_website_request(activate_button) {
    ...
    var wpvs_do_activation_ajax = 'wpvs_theme_activate_customer_access';

    if( activation_action == 'deactivate' ) {
        wpvs_do_activation_ajax = 'wpvs_theme_deactivate_customer_access';
    }
    ...
    if( ! wpvs_check_customer_site_activation_fields(activate_product_type) ) {
        ...
        if( activate_product_type == 'theme' ) {
            var wpvs_license_key = jQuery('#wpvs-enter-theme-license-key').val();
        }
...
function wpvs_check_customer_site_activation_fields(product_type) {
    ...
    if( product_type == 'theme' ) {
        var wpvs_license_key = jQuery('#wpvs-enter-theme-license-key');
    }
