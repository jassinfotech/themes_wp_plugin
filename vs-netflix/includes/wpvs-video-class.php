...
if( ! class_exists('WPVS_SINGLE_VIDEO') ) {
class WPVS_SINGLE_VIDEO {
    ...
    public function get_video_content() {
        if( $this->viewer_can_watch() ) {
            ...
            if($wpvs_video_type == "vimeo") {
                $video_vimeo_id = get_post_meta($this->video_id, 'rvs_video_post_vimeo_id', true);
                $rvs_video_html = '<div id="wpvs-vimeo-video" class="wpvs-vimeo-video-player" data-vimeo-id="'.$video_vimeo_id.'"></div>';
                $video_content .= $rvs_video_html;
            }

            if($wpvs_video_type == "youtube") {
    ...
    public function get_video_thumbnail_image_url() {
        if( has_post_thumbnail($this->video_id) ) {
            ...
            if( empty($thumbnail_image) ) {
                ...
                if(empty($thumbnail_image)) {
                    $thumbnail_image = WPVS_THEME_BASE_URL . 'images/missing-image.png';
                }
            }
        }
...
if( ! class_exists('WPVS_VIDEO_LIST_FILTER') ) {
