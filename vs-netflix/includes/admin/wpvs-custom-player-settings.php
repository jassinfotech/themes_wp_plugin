        ...
        <form method="post" action="options.php">
            ...
            <div class="rvs-container rvs-box">
                <div class="col-12">
                    ...
                    <textarea id="wpvs-js-file-editor" name="wpvs-custom-player[jsfiles]" rows="5" cols="20" class="large-text code" placeholder='<script src="//link-to-script-file.js"></script>'><?php echo $wpvs_custom_player['jsfiles']; ?></textarea>
                    <br>
            ...
            <div class="rvs-container rvs-box">
                <div class="col-12">
                    ...
                    <textarea id="wpvs-css-file-editor" name="wpvs-custom-player[cssfiles]" rows="5" cols="20" class="large-text code" placeholder='<link rel="stylesheet" href="external-styles.css" />'><?php echo $wpvs_custom_player['cssfiles']; ?></textarea>
                </div>
            </div>
            ...
            <div class="rvs-container rvs-box">
                <div class="col-12">
                    ...
                    <textarea id="wpvs-js-editor" name="wpvs-custom-player[customjs]" rows="5" cols="20" class="large-text code" placeholder='var player = playerObject;'><?php echo $wpvs_custom_player['customjs']; ?></textarea>
                </div>
            </div>
            ...
            <div class="rvs-container rvs-box">
                <div class="col-12">
                    ...
                    <textarea id="wpvs-css-editor" name="wpvs-custom-player[customcss]" rows="5" cols="20" class="large-text code" placeholder='.playerClass { margin: 0; }'><?php echo $wpvs_custom_player['customcss']; ?></textarea>
                </div>
            </div>
